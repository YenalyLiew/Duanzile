 ...
 * For example:
 * ```kotlin
 * val singleFlowLaunch = SingleFlowLaunch(viewModelScope)
 *
 * fun foo(param: Any) {
 *     singleFlowLaunch.singleLaunch(UNIQUE_TAG) {
 ...
 */
class SingleFlowLaunch(private val viewModelScope: CoroutineScope) {
