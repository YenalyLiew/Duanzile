 ...
 */
class LikeUserRvAdapter :
    PagingDataAdapter<LikeUserModel.Data, LikeUserRvAdapter.ViewHolder>(COMPARATOR) {
    companion object {
        private val COMPARATOR = object : DiffUtil.ItemCallback<LikeUserModel.Data>() {
            override fun areItemsTheSame(
                oldItem: LikeUserModel.Data,
                newItem: LikeUserModel.Data
            ): Boolean {
